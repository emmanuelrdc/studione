...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 005.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 009.568 3z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 6h.008v.008H6V6zM9 15l6-6" />
      </svg>
    ),
  },
  {
              ...
              >
                {isActive && (
                  <motion.span
                    ...
                    className="absolute inset-0 -z-0 rounded-xl bg-primary-500/[0.12] ring-1 ring-inset ring-primary-500/20"
                  />
                )}
                <span className={`relative z-10 transition-colors duration-200 ${isActive ? "text-primary-400" : "text-white/30 group-hover:text-white/60"}`}>{item.icon}</span>
